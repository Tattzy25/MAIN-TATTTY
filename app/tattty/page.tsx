    ...
    <div className="flex h-[calc(100svh-var(--header-height))] flex-1 flex-col overflow-hidden md:h-[calc(100svh-var(--header-height)-1rem)]">
      <div className="h-full overflow-y-auto">
        <div className="flex min-h-full flex-col px-4 py-4 sm:px-6 lg:px-8">
          <h1 className="pt-4 text-center font-[family-name:var(--font-rock-salt)] font-bold text-3xl sm:pt-[30px] sm:text-5xl md:text-6xl lg:text-7xl">
            INK FEVER?
          </h1>

          <div className="flex flex-1 flex-col items-center justify-center">
            <div className="w-full max-w-full space-y-6 sm:max-w-xl md:max-w-2xl lg:max-w-3xl">
              <PromptInput
                isLoading={isLoading}
                mode={mode}
