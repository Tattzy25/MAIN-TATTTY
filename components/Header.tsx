  ...
  return (
    <header className="mb-4">
      <div className="mx-auto flex items-center justify-between">
        <div>
          <h1 className="flex font-semibold text-xl antialiased sm:font-bold sm:text-2xl">
            <Link
              className="mr-2 flex items-center hover:opacity-75"
              href="/dashboard"
            >
              <SparklesIcon />
              Tattty AI
        ...
        >
          ...
          />
          <Button className="block sm:hidden" size="icon-sm">
            ▲
          </Button>
        </Link>
      </div>
